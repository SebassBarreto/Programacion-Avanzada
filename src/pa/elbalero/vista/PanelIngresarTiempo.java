...
public class PanelIngresarTiempo extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jButton1Jugar.setBackground(new java.awt.Color(153, 0, 0));
        ...
        jButton1Jugar.setText("Aceptar");
        jButton1Jugar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jPanel1.add(jButton1Jugar, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 460, 240, 60));

        jTextField1.setFont(new java.awt.Font("Maiandra GD", 1, 48)); // NOI18N
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 372, 180, 60));
